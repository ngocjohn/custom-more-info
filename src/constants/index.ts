...
export enum SELECTOR {
  ...
  HA_CARD = 'ha-card',
  MORE_INFO_DETAILS = 'ha-more-info-details',
  EXPANSION_PANEL = 'ha-expansion-panel',
  HA_ATTRIBUTE_VALUE = 'ha-attribute-value',
...
const COMPONENTS_PREFIX = `${UI_PREFIX}.components`;
const DIALOGS_PREFIX = `${UI_PREFIX}.dialogs.more_info_control`;

export const DETAILS_REFERENCES = Object.freeze({
  [DETAILS.STATE_TITLE]: `${COMPONENTS_PREFIX}.entity.entity-state-picker.state`,
  [DETAILS.ATTRIBUTES_TITLE]: `${DIALOGS_PREFIX}.attributes`,
});
